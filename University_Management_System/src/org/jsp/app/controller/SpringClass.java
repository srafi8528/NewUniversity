...
public class SpringClass 
{
	...
	public ModelAndView scheduleProgram(@ModelAttribute ProgramsScheduled programsScheduled)
	{
		...
		{
			modelAndView = new ModelAndView("AddScheduleProgram","data","NotUpdated");
		}
		return modelAndView;
	}
	...
	public ModelAndView programsOffered(@ModelAttribute ProgramsOffered programsOffered)
	{
		...
		if("yes".equals(result))
		{
			modelAndView = new ModelAndView("AddProgram","data","Program Added");
		}
		else
		{
			modelAndView = new ModelAndView("AddProgram","data","Program Not Added");
		}
		return modelAndView;
	}
	...
	{	
		...
		{
			modelAndView = new ModelAndView("login","data","Invalid Username");
		}	
		...
		{
			modelAndView = new ModelAndView("login","data","Wrong Password");
		}
		return modelAndView;
	}
	...
	@RequestMapping(value = "/view/updateToReject", method = RequestMethod.POST)
	public ModelAndView updateToReject(@ModelAttribute Application application)
	{
